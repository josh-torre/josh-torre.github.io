          ...
          <div className="flex flex-col items-center justify-center"> 
            ...
            <div className="w-[80%]">
              ...
              <h2 className="font-bold text-2xl pl-2">Preface</h2>
                ...
                <a className="text-my-lighter-teal" target="_blank" href="https://www.amazon.com/Effective-Java-2nd-Joshua-Bloch/dp/0321356683?ie=UTF8&s=books&qid=1223917599&sr=1-1"> (see Joshua Block’s apology for creating Java)</a>
